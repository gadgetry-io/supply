...
// Cmd represents the guide command
var Cmd = &cobra.Command{
	Use:   "guide",
	Short: "supply guide commands",
	Long: `The supply "guide" commands is a built-in help utility

HELP:
  supply guide --help

USAGE:
  supply guide <command> [flags]`,

	Run: func(cmd *cobra.Command, args []string) {
		common.DebugMessage("[package: guide][file: main.go][Cmd Run: func()]")
		common.FmtMessage("text-blue", "Use 'supply guide --help' for more information\n\n")
